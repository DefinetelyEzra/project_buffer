...
Revision ID: 5a077709134f
Revises: 931ca2258b07
Create Date: 2025-04-11 22:24:43.090351
...
revision = '5a077709134f'
down_revision = '931ca2258b07'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.CheckConstraint("profile->>'energy_level' ~ '^[1-9]$|^10$'", name='valid_survey_energy_level'),
    ...
    sa.CheckConstraint('energy_level BETWEEN 1 AND 10', name='valid_behavior_energy_level'),
    sa.ForeignKeyConstraint(['task_id'], ['scarlet.tasks.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['scarlet.users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='scarlet'
